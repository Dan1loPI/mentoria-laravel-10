...
<html lang="pt_br" data-bs-theme="auto">
  <head>
    ...
    <meta name="author" content="Danilo Pinheiro de Oliveira">
    <meta name="generator" content="Hugo 0.112.5">
    <title>Dashboard Template - By Danilo WebData</title>
    ...
    <link rel="icon" href="{{ asset('icons/favicon.png')}}" sizes="32x32" type="image/png">
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">samantha</a>
